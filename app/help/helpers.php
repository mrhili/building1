...
/*
	...
	function thingStatu( $statusNumber = null ){
		...
		$buildingStatusCount = count( $buildingStatus ) +1;
		...
		if( $statusNumber == -1 ){
			...
			if( $statusNumber < -1 || $statusNumber > $buildingStatusCount ){
				
				$statusNumber = $buildingStatusCount;
...
*/
	...
	function buildingKind( $kindsNumber = null ){
...
/***************End Valid*************************/	
	...
	function buildingState( $statusNumber = null ){
